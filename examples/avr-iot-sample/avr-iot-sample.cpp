...
#define IOTCONNECT_CPID "avtds"// "your-cpid"
#define IOTCONNECT_ENV  "Avnet" // "your-env"
#define IOTCONNECT_DUID "" // "your-device-unique-id" or leave blank to use the autogenerated ID printed by avr-iot-provision.ino scketch
#define IOTCONNECT_TEMPLATE_DTG "620C9902-17DD-46B0-A8A2-B20F77EED493" // "your-device-template-dtg"
#define IOTCONNECT_HOST   "poc-iotconnect-iothub-030-eu2.azure-devices.net" //"your-iothub-host"
